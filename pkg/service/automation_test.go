...
// MockTaskExecutionRepository maps TaskExecution repository actions for automation testing context.
...
// MockSiteRepository maps spatial and asset targets.
type MockSiteRepository struct {
	persistence.SiteRepository
}

// MockUserRepository maps profiles.
