...
INSERT INTO users (id, o_auth_provider, o_auth_id, email, name, metadata, created_at, updated_at, version) VALUES
	...
	('88888888-8888-8888-8888-888888880002', 'google', 'user-oauth-id-ryan', 'ryan@rmcguinness.altostrat.com', 'Ryan', '{"title": "Corporate Master Systems Administrator"}', NOW(), NOW(), 1),
...
INSERT INTO user_roles (user_id, role_id) VALUES
	('00000000-0000-0000-0000-000000000000', '77777777-7777-7777-7777-777777770003'), -- Mock User (SITE_MANAGER)
	('88888888-8888-8888-8888-888888880001', '77777777-7777-7777-7777-777777770004'), -- Hanna (SITE_ASSOCIATE)
	('88888888-8888-8888-8888-888888880002', '77777777-7777-7777-7777-777777770001'), -- Ryan (ADMIN)
...
INSERT INTO user_organizations (organization_id, user_id) VALUES
	...
	('11111111-1111-1111-1111-111111111111', '88888888-8888-8888-8888-888888880002'),
	...
	('33333333-3333-3333-3333-333333333333', '88888888-8888-8888-8888-888888880002'), -- Ryan also maps to OmniMart
	...
	('22222222-2222-2222-2222-222222222222', '88888888-8888-8888-8888-888888880002'),
...
INSERT INTO user_sites (id, user_id, site_id, is_primary, metadata, created_at) VALUES
	...
	('88888888-8888-8888-8888-777777770002', '88888888-8888-8888-8888-888888880002', '44444444-4444-4444-4444-444444440000', TRUE, '{}', NOW()),
	('88888888-8888-8888-8888-777777770003', '88888888-8888-8888-8888-888888880002', '55555555-5555-5555-5555-555555550000', FALSE, '{}', NOW()),
...
INSERT INTO events (id, organizer_id, site_id, task_id, name, event_type, event_style, created_at) VALUES
	...
	('99999999-9999-9999-9999-999999990001', '88888888-8888-8888-8888-888888880002', '55555555-5555-5555-5555-555555550000', NULL, 'OmniMart Dallas - Morning Store Opening', 'StoreOpenEvent', 'BATCH', NOW()),
	('99999999-9999-9999-9999-999999990002', '88888888-8888-8888-8888-888888880002', '55555555-5555-5555-5555-555555550000', NULL, 'OmniMart Dallas - Evening Store Closing', 'StoreCloseEvent', 'BATCH', NOW()),
	('99999999-9999-9999-9999-999999990003', '88888888-8888-8888-8888-888888880002', '55555555-5555-5555-5555-555555550000', NULL, 'OmniMart Dallas - Front Registry Audit Sweep', 'RegisterAuditEvent', 'BATCH', NOW()),

	-- B. Brand Specific: OmniMart (Grocery Hypermarket)
	('99999999-9999-9999-9999-999999990011', '88888888-8888-8888-8888-888888880002', '55555555-5555-5555-5555-555555550000', NULL, 'OmniMart Dallas - Fresh Produce Rotation Audit', 'PerishableFreshnessEvent', 'BATCH', NOW()),
	('99999999-9999-9999-9999-999999990012', '88888888-8888-8888-8888-888888880002', '55555555-5555-5555-5555-555555550000', NULL, 'OmniMart Dallas - Kitchen Breakfast-to-Lunch Transition', 'HotFoodTransitionEvent', 'BATCH', NOW()),
	('99999999-9999-9999-9999-999999990013', '88888888-8888-8888-8888-888888880002', '55555555-5555-5555-5555-555555550000', NULL, 'OmniMart Dallas - Curbside Delivery Pickup Run', 'CurbsidePickupEvent', 'BATCH', NOW()),

	-- C. Brand Specific: Volt & Vine (Smart Appliance Showrooms)
	('99999999-9999-9999-9999-999999990021', '88888888-8888-8888-8888-888888880002', '44444444-4444-4444-4444-444444440000', NULL, 'Volt & Vine Seattle - Premium Showcase Swap', 'ShowroomRefreshEvent', 'BATCH', NOW()),
	('99999999-9999-9999-9999-999999990022', '88888888-8888-8888-8888-888888880002', '44444444-4444-4444-4444-444444440000', NULL, 'Volt & Vine Seattle - Luxury Home Delivery Load', 'WhiteGloveDispatchEvent', 'BATCH', NOW()),

	-- D. Base Workforce Shift Events
	-- Associates shifts are registered as Events themselves under GORM scheduling loops
	('99999999-9999-9999-9999-999999990099', '88888888-8888-8888-8888-888888880002', '55555555-5555-5555-5555-555555550000', NULL, 'Hanna Scheduled Shift - Associate Lane Coverage', 'RetailShift', 'BATCH', NOW()),
	('99999999-9999-9999-9999-999999990100', '88888888-8888-8888-8888-888888880002', '44444444-4444-4444-4444-444444440000', NULL, 'Ryan Scheduled Shift - Showroom Supervisor Shift', 'RetailShift', 'BATCH', NOW());
...
INSERT INTO user_event_schedules (id, user_id, event_id, start_date, end_date, timezone, rrule, created_at) VALUES
	...
	('55555555-5555-7777-0000-000000000002', '88888888-8888-8888-8888-888888880002', '99999999-9999-9999-9999-999999990100', '2026-05-18 09:00:00-07:00', '2026-05-22 17:00:00-07:00', 'America/Los_Angeles', 'FREQ=WEEKLY;BYDAY=MO,TU,WE,TH,FR', NOW());
